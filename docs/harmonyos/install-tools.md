...
HUAWEI DevEco Studio是面向HarmonyOS生态的集成开发环境，提供了一站式的HarmonyOS生态应用开发能力。HUAWEI DevEco Studio是面向全场景多设备提供的一站式开发平台，支持多端双向预览、分布式调优、分布式调试、超级终端模拟、低代码可视化开发等能力，帮助开发者降低成本、提升效率、提高质量。

3.1/4.0版本文档归档不再维护，使用最新的 [HarmonyOS NEXT版本](https://developer.huawei.com/consumer/cn/doc/harmonyos-releases/overview-allversion) 文档。

<!-- more -->


**以下笔记内容均为3.1/4.0版本文档** 新文档参考 [下载与安装DevEco Studio新版本](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/ide-software-install) 文档。
