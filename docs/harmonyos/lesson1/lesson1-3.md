...
![](./lesson1-3.assets/true-image-list-Grid.png)
...
![](./lesson1-3.assets/true-image-list.png)
...
![](./lesson1-3.assets/true-image-list-listItem.png)
...
![](./lesson1-3.assets/true-image-list-divider.png)
...
![](./lesson1-3.assets/true-image-list-listDirection-Vertical.png)
...
![](./lesson1-3.assets/true-image-list-listDirection-Horizontal.png)
...
![](./lesson1-3.assets/true-image-grid.jpg)
...
![](./lesson1-3.assets/true-image-grid-2.jpg)
...
![](./lesson1-3.assets/true-image-tabs.png)
...
![](./lesson1-3.assets/true-image-tabs-0.png)
...
<img src="./lesson1-3.assets/true-image-tabs-1.png" style="zoom: 67%;" />
...
- BarMode.Fixed：所有TabBar平均分配barWidth宽度（纵向时平均分配barHeight高度）,页签不可滚动，效果图如下：
  ...
  ![](./lesson1-3.assets/true-image-tabs-Fixed.png)

- BarMode.Scrollable：每一个TabBar均使用实际布局宽度，超过总长度（横向Tabs的barWidth，纵向Tabs的barHeight）后可滑动。

  ![](./lesson1-3.assets/true-image-tabs-Scrollable.png)
...
- - `vertical` 属性方法设置为 false（默认值）时，页签位于容器顶部。
  ...
  ![](./lesson1-3.assets/true-image-tabs-vertical-start-false.png)
...
- - vertical属性方法设置为true时，页签位于容器左侧。
  ...
  ![](./lesson1-3.assets/true-image-tabs-vertical-start-true.png)
...
- - vertical属性方法设置为false时，页签位于容器底部。
  ...
  ![](./lesson1-3.assets/true-image-tabs-vertical-end-false.png)
...
- - vertical属性方法设置为true时，页签位于容器右侧。
  ...
  ![](./lesson1-3.assets/true-image-tabs-vertical-end-true.png)
...
![](./lesson1-3.assets/true-image-tabbar-style.png)
...
![](./lesson1-3.assets/true-image-tabs-builder-1.png)

---

![](./lesson1-3.assets/true-image-tabs-builder-2.png)
