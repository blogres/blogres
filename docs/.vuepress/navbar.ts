...
export const allNavbar = navbar([
    ...
    { text: "Kubernetes", icon: "/icons/k8s/k8s_16x16.png", link: "/k8s/" },
    { text: "Linux", icon: "linux", link: "/linux/" },
    {
        text: "文档类链接",
        icon: "api",
        children: [
            { text: "GitHub", icon: "api", link: "https://github.com/aniuger" },
            { text: "Gitee", icon: "api", link: "https://gitee.com/aniuger" },
            { text: "GitCode", icon: "api", link: "https://gitcode.com/aniuger" },
            ...
            },
            {
                ...
                children: [
                    ...
                    { text: "IntelliJ IDEA下载", icon: "api", link: "https://www.jetbrains.com/zh-cn/idea/download/other/" },
                    ...
                    { text: "YourKit Java性能调优工具", icon: "api", link: "https://www.yourkit.com/docs/" },
                    { text: "Proceson在线流程图思维导图", icon: "api", link: "https://www.processon.com/" },
                    { text: "数据结构在线演示", icon: "api", link: "https://www.cs.usfca.edu/~galles/visualization/Algorithms.html" },
                    { text: "ES-中文", icon: "api", link: "https://www.elastic.co/guide/cn/elasticsearch/guide/current/foreword_id.html" },
                ]
            }
        ],
    },
        ...
        children: [
            {
                ...
                children: [
                    ...
                    { text: "DBeaver数据库管理", icon: "api", link: "https://dbeaver.io/download/" },
                    ...
                    { text: "Kubernetes", icon: "api", link: "https://kubernetes.io/zh-cn/" },
                    { text: "可视化管理工具-kubesphere", icon: "api", link: "https://kubesphere.com.cn/" },
                    { text: "可视化管理工具-Rancher", icon: "api", link: "https://rancher.com/" },
                    { text: "可视化管理工具-kuboard", icon: "api", link: "https://kuboard.cn/" },
                    { text: "监控系统-Prometheus", icon: "api", link: "https://prometheus.io/docs/introduction/overview/" },
                    { text: "监控系统-Zabbix", icon: "api", link: "https://www.zabbix.com/" },
                ]
            },
            {
                text: "其他工具区",
                ...
                children: [
                    ...
                    { text: "FlyEnv本地开发工具箱", icon: "api", link: "https://www.flyenv.com/zh/" },
                    ...
                    { text: "在线修改图片工具", icon: "api", link: "https://www.gaitubao.com/" },
                    ...
                    { text: "String转Hex值", icon: "api", link: "https://codebeautify.org/string-hex-converter" },
                ],
            }
        ],
    },
